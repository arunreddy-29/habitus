...
class SanaArticleScraper extends PageArticleScraper(SanaDomain) {
  ...
  def scrape(browser: Browser, page: Page, html: String): ArticleScrape = {
    ...
    // Extracting Author
    val author = (doc >?> element("meta[name='author']")).map(_.attr("content")).orElse(Some("Syrian Arab News Agency"))
